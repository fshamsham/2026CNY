    ...
    <div className="w-full">
      ...
      {selectedStat && createPortal(
        <div className="fixed inset-0 z-[110] flex flex-col items-center justify-end pt-12 md:pt-20 bg-red-950/25 backdrop-blur-xl animate-in fade-in duration-500">
          <div className="absolute inset-0 z-0" onClick={() => setSelectedKeyword(null)}></div>
              ...
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-3 md:gap-5 overflow-hidden">
                  <div className="bg-red-600 p-2.5 md:p-4 rounded-xl md:rounded-2xl shadow-xl shadow-red-100 shrink-0">
                    <PlayCircle size={20} className="text-white md:size-8" />
                  </div>
                  <div className="min-w-0">
                    <h3 className="text-lg md:text-3xl font-black text-red-950 tracking-tight flex items-baseline gap-2 md:gap-4 uppercase truncate">
                      {selectedStat.name} 
                      <span className="text-[11px] md:text-xl font-bold text-red-900/30 uppercase tracking-[0.2em]">{selectedStat.count} 部作品</span>
                    </h3>
                    <p className="text-[9px] md:text-[11px] font-black text-red-900/40 uppercase tracking-[0.1em] md:tracking-[0.3em] mt-0.5 truncate">作品看板 • Performance Detail</p>
                  </div>
                </div>
                <button 
